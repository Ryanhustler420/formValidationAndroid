package io.raisehand.formvalidation;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // this must be check , but we are skipping this as of now and implement later
        ...
        mDrawerList.setAdapter(new ArrayAdapter<>(this, R.layout.drawer_list_item, mStyles));
    ...
    private class DrawerItemClickListener implements ListView.OnItemClickListener {
        ...
        private void selectItem(int position) {
            ...
            if (position < TEXT_INPUT_LAYOUT.value()) {
                addValidationForEditText(MainActivity.this);
            } else if (position == TEXT_INPUT_LAYOUT.value()) {
                addValidationForTextInputLayout(MainActivity.this);
            }
        }
    }
}
